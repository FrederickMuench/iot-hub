...
public class SimulatedDevice {
  ...
  private static String connString01 = "HostName=teamlambda-iothub.azure-devices.net;DeviceId=fridge01;SharedAccessKey=z9dh/j9FBAT7zGBaC1uh4VJEkGQjyGeHL+ez0JFBDYM=";
  private static String connString02 = "HostName=teamlambda-iothub.azure-devices.net;DeviceId=fridge02;SharedAccessKey=OtDdttsXPnQwM8MVKUd/hT395HHfFzIDfZlaHi22U6s=";
  ...
  private static int telemetryInterval = 2000;

  // Specify the telemetry to send to your IoT hub.
  private static class TelemetryDataPoint {
    public double temperature;
    public double humidity;
    //public final String deviceId = "fridge01";
      ...
      try {
        ...
        while (true) {
          ...
          if (rand.nextDouble() <= 0.01){
            ...
            System.out.println("SENDE FEHLMESSUNG");
          }
          ...
          //System.out.println("Sending message: " + gson.toJson( msg ));
  ...
  public static void main(String[] args) throws IOException, URISyntaxException {
    ...
    if ( args[0].isEmpty() ) {
      connString = connString01;
      System.out.println("Argument empty. Try '1' or '2'");
    }
    else if ( args[0].equals( "1" ) ) {
      connString = connString01;
      System.out.println("Start as 'fridge01'.");
    }
    else if ( args[0].equals( "2" ) ) {
      connString = connString02;
      System.out.println("Start as 'fridge02'.");
    }
    else {
      System.out.println(args[0]);
      System.out.println("Argument invalid. Try '1' or '2'");
      return;
    }
